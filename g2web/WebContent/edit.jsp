...
<body>
	...
	<form action="<c:url value='updateById.do'/>" method="post">
		...
		<table border="0" align="center" width="40%"
			...
			<tr>
				...
				<td width="40%"><input type="text" name="wname"
					value="${customer.wname} " /></td>
				<td align="left"><label id="cnameError" class="error">&nbsp;</label>
				</td>
			</tr>
			<tr>
				<td>商品类型</td>
					<td><input type="text" name="classify" id="classify" value="${customer.classify } " /></td>
				<td><label id="classifyError" class="error">&nbsp;</label></td>
			</tr>
			<tr>
				<td>商品价格</td>
				<td><input type="text" name="price" id="price" value="${customer.price } " /></td>
				<td><label id="priceError" class="error">&nbsp;</label></td>
			</tr>
			
			<tr>
				<td>商品图片</td>
				<td><input type="text" name="img" value="${customer.img }" />
				</td>
				<td><label id="imgError" class="error">&nbsp;</label></td>
			</tr>
			<tr>
				<td>商品关键字</td>
				<td><input type="text" name="keywords" value="${customer.keywords }" />
				</td>
				<td><label id="keywordsError" class="error">&nbsp;</label></td>
			</tr>
			<tr>
				<td>商品点击量</td>
				<td><input type="text" name="pageview" value="${customer.pageview }" />
				</td>
			...
			<tr>
				<td>商品状态</td>
				<td><input type="text" name="status" value="${customer.status }" />
				</td>
				<td><label id="statusError" class="error">&nbsp;</label></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><input type="button" value="编辑商品" onclick="add()" /> <input
